...
public class MyDateTime {
  ...
  /**
   * Instant is the most accurate timestamp as it’s based on nanosecond accuracy.
   */
   ...
   * 1 Solution: http://docs.oracle.com/javase/tutorial/datetime/iso/QandE/MonthsInYear.java
   *
   * @param year
   */
  ...
  /**
   * The Java Tutorial. A Short Course on the Basics. Sixth Edition. Chapter 21: Date-Time Exercise
   * 2 Solution: http://docs.oracle.com/javase/tutorial/datetime/iso/QandE/ListMondays.java
   *
   * @param month
   */
  ...
  /**
   * The Java Tutorial. A Short Course on the Basics. Sixth Edition. Chapter 21: Date-Time Exercise
   * 3 Solution: http://docs.oracle.com/javase/tutorial/datetime/iso/QandE/Superstitious.java
